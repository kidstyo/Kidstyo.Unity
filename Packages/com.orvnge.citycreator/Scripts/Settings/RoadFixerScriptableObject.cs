...
{
    [CreateAssetMenu(fileName = "RoadFixer", menuName = "City Creator/RoadFixer", order = 1)]
    public class RoadFixerScriptableObject : ScriptableObject
    {
        ...
        //[left, up, right, down]
        private bool CreateStraightRoad(PlacementManager placementManager, CellType[] result,
