    ...
    public class StructureManager : MonoBehaviour
    {
        ...
        internal void PlaceBigStructure(Vector3Int position)
        {
            ...
            if (CheckBigStructure(position, width, height))
            {
                ...
                placementManager.PlaceObjectOnTheMap(position, bigStructuresPrefabs[randomIndex].prefab,
                    CellType.Structure, width, height);
            }
        }
        ...
        public void PlaceSpecial(Vector3Int position)
        {
            if (CheckPositionBeforePlacement(position))
            {
                ...
                placementManager.PlaceObjectOnTheMap(position, specialPrefabs[randomIndex].prefab,
